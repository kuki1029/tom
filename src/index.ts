...
const runDiscovery = async (cwd: string, task: string, repos: string[], config: Config): Promise<void> => {
  ...
  const systemPrompt = [
    ...
    "## Mindset",
    "",
    "Interview the user until you have 95% confidence about what they actually want, not what you think they should want.",
    "Ask THEM questions. Don't assume. The gap between what they said and what they meant is where bugs come from.",
    "",
    "## Your job in this session",
    "",
    "- Start by exploring the codebase to understand context. Then interview the user about their intent.",
    "- Ask clarifying questions — what exactly should happen? For whom? When? What's the trigger?",
    "- Challenge vague ideas. Push for specifics. 'It should work better' is not a requirement.",
    ...
    "- Don't move on until you're confident you understand the full picture.",
    "",
